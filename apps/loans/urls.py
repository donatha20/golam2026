...
urlpatterns = [
    ...
    path('repayments/collect/<int:schedule_id>/', views.collect_expected_repayment, name='collect_expected_repayment'),
    ...
    path('overdue-repayments/', views.overdue_repayments, name='overdue_repayments'),
